<template>
  <div class="resume__reserve">
    ...
    <ul class="resume__l">
      ...
      <li class="resume__listItem">
        Quarto: {{ selectedTitle }}
      </li>
      <li class="resume__listItem">
        Valor do quarto: R$ {{ selectedPreco }}
      </li>
    ...
    <AditionalServicesModal
      @totalAditionalServices="handleTotalAditionalServices"
    />
    ...
    <ul class="resume__total">
      ...
      <li class="resume__listItem" :value="somaTotal()">
  ...
  methods: {
    ...
    totalAdicionais() {
      if (this.$store.getters.totalAdicionais.servicosAdicionais.price) {
        console.log(
          this.$store.getters.totalAdicionais.servicosAdicionais.price
        );
      }
    },
    ...
    somaTotal() {
      ...
      const valorAdicional =
        this.$store.getters.agendarDiaria.totalAdicionais ?? 0;
